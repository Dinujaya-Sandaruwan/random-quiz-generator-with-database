...
$sql = "INSERT INTO `media_quiz`( `u_name`, `quiz`, `f_ans`, `s_ans`, `t_ans`, `fo_ans`, `correct_ans`, `s_notes`) VALUES ('$name','$quiz','$f_ans','$s_ans ','$t_ans','$fo_ans','$correct_ans','$s_note')";
...
header("Location: ../add-done/media-done.php");

...
$sql = "INSERT INTO `quiz_tbl`( `u_name`, `q_subject`, `quiz`, `f_ans`, `s_ans`, `t_ans`, `fo_ans`, `correct_ans`, `s_notes`) VALUES ('$name','$subject','$quiz','$f_ans','$s_ans ','$t_ans','$fo_ans','$correct_ans','$s_note')";
...
header("Location: ../add-done/quiz-done.php");
